...
PACKAGES+=" adb htop lolcat python3-pip zram-swap luci-app-poweroff luci-app-ramfree luci-app-ttyd luci-app-lite-watchdog luci-app-ipinfo luci-app-mactodong"
...
handle_profile_packages() {
    if [ "$1" == "rpi-4" ]; then
        ...
        PACKAGES+=" kmod-iwlwifi kmod-ath10k iw-full pciutils ath10k-firmware-qca9377 openssh-sftp-server"
    fi
